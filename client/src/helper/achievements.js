...
export const achievements = [
    ...
    {
        name: "ISS SSTV Image Decoding",
        details: "During the ARISS event commemorating the Apollo-Soyuz and STS-51F missions, our amateur radio club proudly received and decoded an SSTV image transmitted from the ISS. New Leap Labs (VU2CWN) participated using a Baofeng UV-5R and the Robot36 app during the ISS pass on July 20, 2025. The successful reception earned us ARISS SSTV Award Certificate No. 282703—another milestone in our space communication journey.",
        date: "ON 20th JUL 2025",
        image: '/assets/imageDecoder7.jpg'
    },
    {
        name: "Anveshan",
    ...
    },
    {
        ...
        image: '/assets/jovianMoonContest.jpg'
    }
